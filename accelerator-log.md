...
```json
{
  ...
  "backendService" : "customer-profile-backend.demo",
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=Mpluya&repo=angular-frontend",
...
┃ ┃ ┃ Debug Adding symbol backendServiceResourceName with value 'customer-profile-backend.demo'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=Mpluya&repo=angular-frontend'
